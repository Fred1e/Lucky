...
zokou({
  ...
  _0x241d6c("All pending join requests have been rejected by *Lucky_Md*.");
});
zokou({
  'nomCom': 'disap7',
  'categorie': "Group",
...
zokou({
  ...
  _0x298913("All pending participants have been approved to Join by *Lucky_Md*.");
});
zokou({
  'nomCom': "vcf",
  ...
  try {
    ...
    await _0x2e5b52("A moment, *LUCKY_MD* is compiling " + _0x267c2d.length + " contacts into a vcf...");
